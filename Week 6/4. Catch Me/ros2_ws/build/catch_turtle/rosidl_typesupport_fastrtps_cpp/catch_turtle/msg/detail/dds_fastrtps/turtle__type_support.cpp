...
#include "catch_turtle/msg/detail/turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const catch_turtle::msg::Turtle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  catch_turtle::msg::Turtle & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
...
{
  auto typed_message =
    static_cast<const catch_turtle::msg::Turtle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<catch_turtle::msg::Turtle *>(
    untyped_ros_message);
...
{
  return &catch_turtle::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, catch_turtle, msg, Turtle)() {
  return &catch_turtle::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
