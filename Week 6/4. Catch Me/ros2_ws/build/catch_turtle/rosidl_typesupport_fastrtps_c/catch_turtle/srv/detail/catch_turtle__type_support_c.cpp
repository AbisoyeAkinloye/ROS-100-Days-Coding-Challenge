...
#include "catch_turtle/srv/detail/catch_turtle__rosidl_typesupport_fastrtps_c.h"
...
#include "catch_turtle/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _CatchTurtle_Request__ros_msg_type = catch_turtle__srv__CatchTurtle_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_catch_turtle
size_t get_serialized_size_catch_turtle__srv__CatchTurtle_Request(
  const void * untyped_ros_message,
...
static uint32_t _CatchTurtle_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_catch_turtle__srv__CatchTurtle_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_catch_turtle
size_t max_serialized_size_catch_turtle__srv__CatchTurtle_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_catch_turtle__srv__CatchTurtle_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, catch_turtle, srv, CatchTurtle_Request)() {
...
using _CatchTurtle_Response__ros_msg_type = catch_turtle__srv__CatchTurtle_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_catch_turtle
size_t get_serialized_size_catch_turtle__srv__CatchTurtle_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CatchTurtle_Response__ros_msg_type * ros_message = static_cast<const _CatchTurtle_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_catch_turtle__srv__CatchTurtle_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_catch_turtle
size_t max_serialized_size_catch_turtle__srv__CatchTurtle_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_catch_turtle__srv__CatchTurtle_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, catch_turtle, srv, CatchTurtle_Response)() {
...
// already included above
// #include "catch_turtle/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "catch_turtle/srv/catch_turtle.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, catch_turtle, srv, CatchTurtle)() {
