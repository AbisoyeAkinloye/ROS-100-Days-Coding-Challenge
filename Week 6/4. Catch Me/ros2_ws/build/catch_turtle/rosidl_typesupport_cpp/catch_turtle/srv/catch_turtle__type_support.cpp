...
static const _CatchTurtle_Request_type_support_symbol_names_t _CatchTurtle_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, catch_turtle, srv, CatchTurtle_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, catch_turtle, srv, CatchTurtle_Request)),
  }
};
...
{
  return &::catch_turtle::srv::rosidl_typesupport_cpp::CatchTurtle_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, catch_turtle, srv, CatchTurtle_Request)() {
  return get_message_type_support_handle<catch_turtle::srv::CatchTurtle_Request>();
}
...
static const _CatchTurtle_Response_type_support_symbol_names_t _CatchTurtle_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, catch_turtle, srv, CatchTurtle_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, catch_turtle, srv, CatchTurtle_Response)),
  }
};
...
{
  return &::catch_turtle::srv::rosidl_typesupport_cpp::CatchTurtle_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, catch_turtle, srv, CatchTurtle_Response)() {
  return get_message_type_support_handle<catch_turtle::srv::CatchTurtle_Response>();
}
...
static const _CatchTurtle_type_support_symbol_names_t _CatchTurtle_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, catch_turtle, srv, CatchTurtle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, catch_turtle, srv, CatchTurtle)),
  }
};
...
{
  return &::catch_turtle::srv::rosidl_typesupport_cpp::CatchTurtle_service_type_support_handle;
}
