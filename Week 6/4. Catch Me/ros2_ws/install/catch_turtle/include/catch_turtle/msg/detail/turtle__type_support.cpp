...
{
  new (message_memory) catch_turtle::msg::Turtle(_init);
}

void Turtle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<catch_turtle::msg::Turtle *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Turtle_message_member_array[4] = {
  {
    ...
    offsetof(catch_turtle::msg::Turtle, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(catch_turtle::msg::Turtle, x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(catch_turtle::msg::Turtle, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(catch_turtle::msg::Turtle, theta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Turtle_message_members = {
  ...
  "Turtle",  // message name
  4,  // number of fields
  sizeof(catch_turtle::msg::Turtle),
...
get_message_type_support_handle<catch_turtle::msg::Turtle>()
{
  return &::catch_turtle::msg::rosidl_typesupport_introspection_cpp::Turtle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, catch_turtle, msg, Turtle)() {
  return &::catch_turtle::msg::rosidl_typesupport_introspection_cpp::Turtle_message_type_support_handle;
}
