...
#include <stddef.h>
#include "catch_turtle/msg/detail/turtle_array__rosidl_typesupport_introspection_c.h"
...
// Member `turtles`
#include "catch_turtle/msg/turtle.h"
// Member `turtles`
#include "catch_turtle/msg/detail/turtle__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  catch_turtle__msg__TurtleArray__init(message_memory);
}

void TurtleArray__rosidl_typesupport_introspection_c__TurtleArray_fini_function(void * message_memory)
{
  catch_turtle__msg__TurtleArray__fini(message_memory);
}

size_t TurtleArray__rosidl_typesupport_introspection_c__size_function__Turtle__turtles(
  const void * untyped_member)
{
  const catch_turtle__msg__Turtle__Sequence * member =
    (const catch_turtle__msg__Turtle__Sequence *)(untyped_member);
  return member->size;
}
...
{
  catch_turtle__msg__Turtle__Sequence * member =
    (catch_turtle__msg__Turtle__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  catch_turtle__msg__Turtle__Sequence * member =
    (catch_turtle__msg__Turtle__Sequence *)(untyped_member);
  catch_turtle__msg__Turtle__Sequence__fini(member);
  return catch_turtle__msg__Turtle__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember TurtleArray__rosidl_typesupport_introspection_c__TurtleArray_message_member_array[1] = {
  {
    ...
    offsetof(catch_turtle__msg__TurtleArray, turtles),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers TurtleArray__rosidl_typesupport_introspection_c__TurtleArray_message_members = {
  "catch_turtle__msg",  // message namespace
  "TurtleArray",  // message name
  1,  // number of fields
  sizeof(catch_turtle__msg__TurtleArray),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, catch_turtle, msg, TurtleArray)() {
  TurtleArray__rosidl_typesupport_introspection_c__TurtleArray_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, catch_turtle, msg, Turtle)();
