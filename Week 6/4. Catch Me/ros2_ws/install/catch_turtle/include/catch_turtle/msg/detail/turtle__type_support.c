  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  catch_turtle__msg__Turtle__init(message_memory);
}

void Turtle__rosidl_typesupport_introspection_c__Turtle_fini_function(void * message_memory)
{
  catch_turtle__msg__Turtle__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Turtle__rosidl_typesupport_introspection_c__Turtle_message_member_array[4] = {
  {
    ...
    offsetof(catch_turtle__msg__Turtle, name),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(catch_turtle__msg__Turtle, x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(catch_turtle__msg__Turtle, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(catch_turtle__msg__Turtle, theta),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Turtle__rosidl_typesupport_introspection_c__Turtle_message_members = {
  ...
  "Turtle",  // message name
  4,  // number of fields
  sizeof(catch_turtle__msg__Turtle),
