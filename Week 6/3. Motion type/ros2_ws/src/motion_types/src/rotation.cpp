...
public:
    Rotation() : Node("rotation")
    {
        ...
        Rotation::set_params();
        timer_ =  this->create_wall_timer(std::chrono::seconds(1),std::bind(&Rotation::rotate, this));
    }
...
private:
    void set_params(){
        ...
        std::cout << "Enter [1] for CW rotation and [0] for CCW rotation: ";
        std::cin >> isClockwise;
    ...
    rclcpp::Clock time; bool isClockwise;
    int t0, t1, dt;
};
