...
class Metaclass_SetLed_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('battery_interface')
        except ImportError:
            import logging
            import traceback
    ...
    def battery_state(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'battery_state' field must be an integer in [-9223372036854775808, 9223372036854775807]"
...
class Metaclass_SetLed(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from battery_interface.srv import _set_led
...
class SetLed(metaclass=Metaclass_SetLed):
    from battery_interface.srv._set_led import SetLed_Request as Request
    from battery_interface.srv._set_led import SetLed_Response as Response
