...
class Metaclass_ComputeRectangleArea(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.srv.ComputeRectangleArea')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from custom_interfaces.srv import _compute_rectangle_area
...
class ComputeRectangleArea(metaclass=Metaclass_ComputeRectangleArea):
    from custom_interfaces.srv._compute_rectangle_area import ComputeRectangleArea_Request as Request
    from custom_interfaces.srv._compute_rectangle_area import ComputeRectangleArea_Response as Response
