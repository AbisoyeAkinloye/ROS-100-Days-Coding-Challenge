...
#ifndef CUSTOM_INTERFACES__MSG__DETAIL__HARDWARE_STATUS__FUNCTIONS_H_
#define CUSTOM_INTERFACES__MSG__DETAIL__HARDWARE_STATUS__FUNCTIONS_H_
...
#endif  // CUSTOM_INTERFACES__MSG__DETAIL__HARDWARE_STATUS__FUNCTIONS_H_
