...
#include <stddef.h>
#include "custom_interfaces/msg/detail/battery_state__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  custom_interfaces__msg__BatteryState__init(message_memory);
}

void BatteryState__rosidl_typesupport_introspection_c__BatteryState_fini_function(void * message_memory)
{
  custom_interfaces__msg__BatteryState__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember BatteryState__rosidl_typesupport_introspection_c__BatteryState_message_member_array[1] = {
  {
    ...
    offsetof(custom_interfaces__msg__BatteryState, battery_state),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers BatteryState__rosidl_typesupport_introspection_c__BatteryState_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interfaces__msg__BatteryState),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, msg, BatteryState)() {
