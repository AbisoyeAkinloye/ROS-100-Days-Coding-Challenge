...
{
  new (message_memory) custom_interfaces::msg::BatteryState(_init);
}

void BatteryState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::msg::BatteryState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BatteryState_message_member_array[1] = {
  {
    ...
    offsetof(custom_interfaces::msg::BatteryState, battery_state),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BatteryState_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interfaces::msg::BatteryState),
...
{
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::BatteryState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, msg, BatteryState)() {
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::BatteryState_message_type_support_handle;
}
