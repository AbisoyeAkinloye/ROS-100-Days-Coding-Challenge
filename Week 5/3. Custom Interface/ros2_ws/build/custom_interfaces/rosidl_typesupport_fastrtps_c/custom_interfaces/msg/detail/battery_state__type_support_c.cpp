...
#include "custom_interfaces/msg/detail/battery_state__rosidl_typesupport_fastrtps_c.h"
...
using _BatteryState__ros_msg_type = custom_interfaces__msg__BatteryState;
...
size_t get_serialized_size_custom_interfaces__msg__BatteryState(
  const void * untyped_ros_message,
...
static uint32_t _BatteryState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__msg__BatteryState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__msg__BatteryState(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_custom_interfaces__msg__BatteryState(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, msg, BatteryState)() {
