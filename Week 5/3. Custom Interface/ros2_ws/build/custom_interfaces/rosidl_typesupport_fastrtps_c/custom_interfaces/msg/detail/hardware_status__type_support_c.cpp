...
#include "custom_interfaces/msg/detail/hardware_status__rosidl_typesupport_fastrtps_c.h"
...
{
  return max_serialized_size_custom_interfaces__msg__HardwareStatus(
    full_bounded, 0);
}
